//
//  LXProfessionalFeesController.m
//   一起留学
//
...
@interface LXProfessionalFeesController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation LXProfessionalFeesController
