//
//  LXSearchSchoolViewController.m
//   一起留学
//
...
#import "LXTuitionRankController.h"
#import "LXHotViewController.h"
#import "LXFilterViewController.h"
@interface LXSearchSchoolViewController ()<UIScrollViewDelegate>
{
}
//小红条
...
@implementation LXSearchSchoolViewController
...
//添加子控制器
- (void)setUpChildVcs{
    LXHotViewController *hot=[[LXHotViewController alloc]init];
    [self addChildViewController:hot];
    
    LXTuitionRankController  *Tuition=[[LXTuitionRankController alloc]init];
    [self addChildViewController:Tuition];
    
    LXQSRankController *QS=[[LXQSRankController alloc]init];
