...
@interface LXTuitionRankController ()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation LXTuitionRankController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        ...
        cell.School.text=@"西澳大学";
        cell.SchoolName.text=@"The University of Melbourne";
        cell.SchoolImage.image=[UIImage imageNamed:@"xiao.png"];
